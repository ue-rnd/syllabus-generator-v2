<div class="p-4 space-y-10">
    <div class="max-w-7xl border border-accent-ghost-dark mx-auto bg-accent-foreground rounded-xl shadow">
        <div class="border-b border-accent-ghost-dark px-4 py-2 flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="size-5 fill-accent-text">
            ...
            <h4 class="text-medium text-accent-text font-bold">Bookmarks</h4>
        </div>
        <table class="w-full text-accent-text">
            <thead class="text-accent-desc">
                <tr class="border-b border-accent-ghost-dark">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" class="text-center py-2 text-sm font-medium text-accent-desc">No bookmarks found.</td>
                </tr>
            </tbody>
        </table>
    </div>
