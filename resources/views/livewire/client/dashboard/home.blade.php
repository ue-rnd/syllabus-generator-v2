        ...
        <div class="col-span-full">
            <div class="text-center">
                ...
                <p class="text-gray-500 mb-8 max-w-md mx-auto leading-relaxed">
                    @if($search || $statusFilter)
                        No syllabi match your current filters. Try adjusting your search criteria or clear the filters to see all syllabi.
                    @else
                        You haven't created any syllabi yet. Get started by creating your first syllabus to organize your course content.
                    @endif
                </p>
                @if(!$search && !$statusFilter)
                    <a href="{{ route('syllabus') }}" wire:navigate class="inline-flex items-center gap-2 bg-red-700 text-white px-6 py-3 rounded-xl hover:bg-red-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 shadow-sm hover:shadow-md">
                ...
                @else
                    <button wire:click="clearFilters" class="inline-flex items-center gap-2 bg-gray-100 text-gray-700 px-6 py-3 rounded-xl hover:bg-gray-200 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
